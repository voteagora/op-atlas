export const CheckboxCircleFIll = ({
  className,
  fill = "#000",
}: {
  className?: string
...
export const BadgeIcon = ({
  ...
  >
    ...
    <path d="m9.7 17.3-4.6 4.6V17a5 5 0 0 1 5-5h3.8a5 5 0 0 1 5 5v4.9l-4.6-4.6" />
  </svg>
)
...
export const CalendarEventFill = ({
  className,
  fill = "#404454",
}: {
  className?: string
