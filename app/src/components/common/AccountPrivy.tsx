...
export function AccountPrivy() {
    const { ready, connectOrCreateWallet, authenticated, login, logout } = usePrivy()
    ...
    return (
        <div className="cursor-pointer text-white bg-[#FF0420] rounded-md px-4 py-2" onClick={() => login()}>Login</div>
    )
}
