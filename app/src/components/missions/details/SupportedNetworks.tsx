      ...
      <div className="flex flex-wrap gap-y-2 gap-x-1.5">
        {supportedChains.map((chain) => (
          <Link
            ...
            className="pl-2.5 pr-3 py-2 bg-backgroundSecondary rounded-full inline-flex justify-start items-center gap-1.5 hover:bg-backgroundSecondary/90 transition-colors"
          >
            <Image
              src={chain.logo}
              alt={chain.name}
