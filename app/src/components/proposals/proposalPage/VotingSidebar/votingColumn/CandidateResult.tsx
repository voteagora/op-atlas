  ...
  return (
    <div className="w-full h-10 p-2 text-sm text-secondary-foreground ">
      <div className="flex flex-row gap-2 justify-between items-center">
        ...
        <div className="flex flex-row gap-2 items-center ">
          <div className="w-[60px] h-6 px-1 py-2 gap-2 flex items-center justify-center rounded-md bg-success text-success-foreground text-xs font-semibold border border-green-400">
            Elected
          </div>
          <ChevronRight
            width={12}
