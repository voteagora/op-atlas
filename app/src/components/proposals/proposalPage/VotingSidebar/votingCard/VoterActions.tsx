...
const CardAction = ({
  ...
  if (loading) {
    return (
      <div
        className={`rounded-md border border-solid p-3 mb-1 w-full sm:w-[256px] h-10 flex items-center justify-center font-medium text-sm leading-5 font-inter ${buttonStyle}`}
      >
