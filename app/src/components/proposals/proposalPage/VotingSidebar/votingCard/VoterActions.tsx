...
const CardAction = ({
  ...
  if (loading) {
    return (
      <div
        className={`rounded-md border border-solid p-3 w-full sm:w-[256px] h-10 flex items-center justify-center font-medium text-sm leading-5 font-riforma ${buttonStyle}`}
      >
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`rounded-md border-solid p-3 w-full sm:w-[256px] h-10 flex items-center justify-center font-medium text-sm leading-5 font-riforma ${buttonStyle} ${
