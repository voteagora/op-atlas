    ...
    <div className="flex flex-col gap-y-4 mt-12 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 gap-x-4 justify-between">
        {attestations.map((attestation) => (
          <div
            key={attestation.id}
            className="rounded-xl border border-gray-200 p-6 bg-background group"
          >
            ...
            <div className="inline-flex gap-x-2 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <OutboundArrowLink
                text="About"
