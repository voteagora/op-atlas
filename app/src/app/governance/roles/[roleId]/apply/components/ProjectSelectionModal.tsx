...
export const ProjectSelectionModal = ({
  ...
  const dialogContent = (
    <DialogContent className="border-tertiary rounded-xl p-0 max-w-[458px] shadow-[0px_4px_6px_-4px_rgba(16,24,40,0.1),0px_10px_15px_-3px_rgba(0,0,0,0.1)]">
      {userProjects?.projects && userProjects.projects.length > 0 ? (
        ...
        <>
          <DialogHeader className="p-6 pb-4 text-center">
            ...
            <div className="text-base font-normal text-[#404454] leading-[24px]">
              Click below to add your project to Atlas. To join a project or organization that already exists in Atlas, please have their admin add you.
            </div>
          </DialogHeader>
