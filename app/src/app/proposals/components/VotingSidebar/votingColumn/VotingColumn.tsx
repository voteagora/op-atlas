...
const VotingColumn = () => {
  return (
    <div className="w-[19rem] h-[25.25rem] pt-[1.5rem] pr-[1rem] pb-[1.5rem] pl-[1rem] gap-[var(--dimensions-8)] border-l border-b border-r rounded-b-[0.75rem]">
      <div className="w-[17rem] h-[22.25rem] gap-4 flex flex-col">
