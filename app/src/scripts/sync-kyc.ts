 ...
 * - PERSONA_INQUIRY_KYC_TEMPLATE_ID: Required for creating KYC inquiries
 * - PERSONA_KYB_TEMPLATE_ID: Required for creating KYB inquiries
 *
 * Usage:
  ...
  if (command === "new-inquiry") {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.log(
          `PERSONA_INQUIRY_KYC_TEMPLATE_ID: ${
            process.env.PERSONA_INQUIRY_KYC_TEMPLATE_ID ? "Set" : "Not Set"
          }`,
        )
        console.log(
          `PERSONA_KYB_TEMPLATE_ID: ${
            process.env.PERSONA_KYB_TEMPLATE_ID ? "Set" : "Not Set"
          }`,
        )
        console.log(
