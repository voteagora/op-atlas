...
function getKYCEmailTemplate(kycUser: KYCUser, kycLink: string): string {
  return `
    ...
    <div style="text-align: center; margin-bottom: 30px;">
        <img src="${baseUrlForAssets}/assets/images/sunny_default.png" alt="Sunny Logo" style="width: 120px; height: auto;"/>
    </div>
    ...
    <div style="text-align: center;">
        <img src="${baseUrlForAssets}/assets/icons/optimismAtlasLogo.png" alt="OP Atlas Logo" style="width: 264px; height: auto;"/>
    </div>
</div>
    `
}
