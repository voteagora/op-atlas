...
export const growthGrantsData: MissionData = {
  ...
  details: [
    "Retro Funding: Growth Grants are for Superchain apps that have already launched and are looking to scale their impact inline with the Collective Intent. Projects submit a plan for growth, methods for measuring success, and their desired capital allocation to execute their plan.",
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="retro-funding" className="">
          ...
          <AccordionContent className="mt-6 mb-6">
            ...
            <p className="mt-6">
              <span className="font-semibold">Why this metric?</span> Interop
          ...
          <AccordionContent className="mt-6 mb-6">
            <ul>
              <li>
                ...
                transactions that interact with the L2ToL2CrossDomainMessenger
                contract
              </li>
              <li>
            ...
            <p className="mt-6">
              <span className="font-semibold">Why this metric?</span> The total
